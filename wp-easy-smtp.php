...
class WP_Easy_SMTP {
	...
	public $OPTIONS;
	public $SLUG = "wpesmtp";
	private $DEFAULT_OPTIONS = array( 'from_email_field' => '', 'from_name_field' => '', 'mailer' => 'smtp', 'smtp_settings' => array( 'host' => '', 'type_encryption' => 'ssl', 'port' => 465, 'autentication' => 'yes', 'username' => '', 'password' => '' ) );
...
?>
		...
		<div class="wpesmtp-box">
			...
			<div class="inside">
				...
				<form id="wpesmtp_settings_form" method="post" action="">
					...
					<table class="form-table">
						<tr valign="top">
							...
							<td>
								<input type="text" name="wpesmtp_from_name" value="<?php echo esc_attr( stripcslashes( $options['from_name_field'] ) ); ?>"/><br />
						...
						<tr class="ad_opt wpesmtp_smtp_options">
					...
					<table class="form-table">
						...
						<tr class="ad_opt wpesmtp_smtp_options field" rel="userpass">
							...
							<td>
								<input type='password' name='wpesmtp_smtp_password' value='<?php echo esc_attr( wpesmtp_get_password() ); ?>' /><br />
				...
				<form id="wpesmtp_testing_form" method="post" action="">
					...
					<table class="form-table">
						...
						<tr valign="top">
							...
							<td>
								<input type="text" name="wpesmtp_subject" value="<?php echo esc_html( stripcslashes( $smtp_test_mail['wpesmtp_subject'] ) ); ?>" /><br />
						...
						<tr valign="top">
							...
							<td>
								<textarea name="wpesmtp_message" id="wpesmtp_message" rows="8"><?php echo esc_textarea( stripcslashes( $smtp_test_mail['wpesmtp_message'] ) ); ?></textarea><br />
			...
			if ( $task == "settings" ) {
				...
				if ( isset( $p['wpesmtp_from_email'] ) && !empty( $p['wpesmtp_from_email'] ) ) {
					if ( is_email( $p['wpesmtp_from_email'] ) ) {
						...
						$error[] = "<li>" . __( "Please enter a valid email address in the 'From Email' field.", 'wp-easy-smtp' ) . "</li>";
					}
				} else {
